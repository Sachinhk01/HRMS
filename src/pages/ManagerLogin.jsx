...
export function ManagerLogin() {
  ...
  const [email, setEmail] = useState(() => getRememberedEmail('MANAGER'));
  const [password, setPassword] = useState('');
  const [showPassword, setShowPassword] = useState(false);
  const [rememberMe, setRememberMe] = useState(() => Boolean(getRememberedEmail('MANAGER')));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await login({ email, password, expectedRole: 'MANAGER', rememberMe });
      setRememberedEmail('MANAGER', rememberMe ? email : '');
      navigate('/dashboard');
    } catch (error) {
  ...
  return (
    <div className="hrms-login hrms-login--manager">
            ...
            <motion.div className="hrms-login__floatcard-wrap" variants={cardRise}>
              ...
              >
                <div className="hrms-login__floatcard-head">
                  <span className="hrms-login__floatcard-label">Approvals</span>
